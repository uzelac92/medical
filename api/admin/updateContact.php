<?php
    ...
    $sql = "UPDATE `medicuser` SET `FNAME`=:fname, `LNAME`=:lname, `USEMAIL`=:mail, `SALUTE`=:salute, `NOTES`=:notes, `PHONE`=:phone, `ADRES`=:adres,`DOB`=:dob, `ZIP`=:zip, `CITY`=:city, `ADRES`=:insurance
